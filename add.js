...
let number = prompt('Пользователь введи число');
    number = number ** 2;
alert(number);
...
// которые выходят за пределы диапазона типа number.

let num = 9007199254740991n
alert(num);       // 9007199254740991n
alert(num + 1n);  // 9007199254740992n
alert(num + 2n);  // 9007199254740993n
alert(num + 3n);  // 9007199254740994n


//Интерполяция
//Использование косых кавычек позволяет нам применять такой прием как интерполяция - 
// встраивать данные в строку.
...
// после которого в фигурных скобках указывается выражение.

let user = "Tom";
let age = 37;
let isMarried = false;
let text = `Name: ${user}   Age: ${age}   IsMarried: ${isMarried}`;
alert(text);  // Name: Tom   Age: 37   IsMarried: false

//Слабая типизация
//JavaScript является языком со слабой типизацией. 
// Это значит, что переменные могут динамически менять тип.
